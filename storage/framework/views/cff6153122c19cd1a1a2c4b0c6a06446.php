...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center" >
                    <a href="<?php echo e(route('password.request')); ?>" class="text-success text-decoration-none small text-dark">Forgot your tactics?</a>
                </p>

                <p class="text-center mb-0 text-dark">
                    Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-success fw-bold text-decoration-none text-dark">Register here</a>
                </p>
            </div>
        </div>
    </div>
